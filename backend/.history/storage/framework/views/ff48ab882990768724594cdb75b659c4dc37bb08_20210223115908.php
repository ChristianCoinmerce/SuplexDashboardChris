    ...
    <div class="ps__rail-x" style="left: 0px; bottom: -41px;"><div class="ps__thumb-x" tabindex="0" style="left: 0px; width: 0px;"></div></div><div class="ps__rail-y" style="top: 41px; right: 0px; height: 895px;"><div class="ps__thumb-y" tabindex="0" style="top: 40px; height: 855px;"></div></div></ul>
    <button class="c-sidebar-minimizer c-class-toggler" type="button" data-target="_parent" data-class="c-sidebar-minimized"></button>

<?php /**PATH /Users/coinmerce1/Documents/laravel-8-crud-app/resources/views/dashboard/shared/sidebar.blade.php ENDPATH**/ ?>
