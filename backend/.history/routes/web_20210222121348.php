...
#roles
Route::get('user-role', [RoleController::class, 'create'])->name('user-role.connect_permission');
Route::post('user-role', [RoleController::class, 'store'])->name('user-role.store');

// user_role
Route::get('users', [UserController::class, 'connect_roles'])->name('user-role.connect_roles');
Route::post('/users', [UserController::class, 'store_userrole'])->name('user-role.store_userrole');
Route::post('/user-role/create', [UserController::class, 'store_user'])->name('user-role.store_user');
Route::get('/user-role/delete/{id}', [UserController::class, 'destroy'])->name('user-role.destroy');
Route::get('/user-role/destroyAll', [UserController::class, 'destroyAll'])->name('user-role.destroyAll');
