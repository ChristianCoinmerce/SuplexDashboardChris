...
Route::group(['middleware' => ['auth', 'myauthcheck:1']], function () {
    ...
    Route::group(['middleware' => 'myauthcheck:11'], function () {
        Route::get('/dashboard/posts/edit/{slug}', [PostController::class, 'edit']);
        Route::post('/dashbpard/posts/update', [PostController::class, 'update_crud']);
        Route::post('/dashboard/edit/{slug}', [PostController::class, 'update_crud'])->name('posts.update');
    });
