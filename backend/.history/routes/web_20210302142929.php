...
Route::group(['middleware' => 'myauthcheck:1'], function () {
    ...
    //POSTS CRUD
    Route::group(['middleware' => 'myauthcheck:7'], function () {
        Route::get('/dashboard/posts', [RoleController::class, 'create'])->name('roles.index');
    });
    Route::group(['middleware' => 'myauthcheck:6'], function () {
        Route::post('/dashboard/posts/store', [RoleController::class, 'store'])->name('roles.store');
    });
    Route::group(['middleware' => 'myauthcheck:8'], function () {
        Route::post('/dashboard/posts/update', [RoleController::class, 'update'])->name('roles.update');
    });
    Route::group(['middleware' => 'myauthcheck:9'], function () {
        Route::get('/dashboard/posts/destroy/{id}', [RoleController::class, 'destroy'])->name('roles.destroy');
    });
