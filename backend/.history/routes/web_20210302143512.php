...
Route::group(['middleware' => 'myauthcheck:1'], function () {
    ...
    Route::group(['middleware' => 'myauthcheck:7'], function () {
        Route::get('/dashboard/roles', [RoleController::class, 'create_crud'])->name('roles.index');
    });
    Route::group(['middleware' => 'myauthcheck:6'], function () {
        Route::post('/dashboard/roles/store', [RoleController::class, 'store_crud'])->name('roles.store');
    });
    ...
    Route::group(['middleware' => 'myauthcheck:10'], function () {
        Route::post('/dashboard/posts/store', [PostController::class, 'show_crud'])->name('posts.store');
    });
    ...
    Route::group(['middleware' => 'myauthcheck:13'], function () {
        Route::get('/dashboard/comments', [CommentController::class, 'show_crud'])->name('comment.index');
    });
    Route::group(['middleware' => 'myauthcheck:14'], function () {
        Route::post('/dashboard/comments/update', [CommentController::class, 'update_crud'])->name('comment.update');
    });
    Route::group(['middleware' => 'myauthcheck:15'], function () {
        Route::get('/dashboard/comments/destroy/{id}', [CommentController::class, 'destroy_crud'])->name('comment.destroy');
    });
