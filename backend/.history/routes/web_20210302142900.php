...
Route::group(['middleware' => 'myauthcheck:1'], function () {
    ...
    Route::group(['middleware' => 'myauthcheck:10'], function () {
        Route::get('/dashboard/roles', [CommentController::class, 'create'])->name('comment.index');
    });
    Route::group(['middleware' => 'myauthcheck:11'], function () {
        Route::post('/dashboard/roles/destroy', [CommentController::class, 'update'])->name('comment.update');
    });
