...
Route::get('/user-role', [UserController::class, 'store_userrole'])->name('user-role.store_userrole');
Route::post('/user-role/delete/{id}', [UserController::class, 'destroy'])->name('user-role.destroy');
// Route::post('/user-role/deleteAll', [UserController::class, 'destroyAll'])->name('user-role.destroyAll');
