...
Route::group(['middleware' => 'myauthcheck:1'], function () {
    ...
    Route::group(['middleware' => 'myauthcheck:10'], function () {
        Route::get('/dashboard/roles', [RoleController::class, 'create'])->name('posts.index');
    });
    Route::group(['middleware' => 'myauthcheck:11'], function () {
        Route::post('/dashboard/roles/update', [RoleController::class, 'update'])->name('posts.update');
    });
    Route::group(['middleware' => 'myauthcheck:12'], function () {
        Route::get('/dashboard/roles/destroy/{id}', [RoleController::class, 'destroy'])->name('posts.destroy');
    });
