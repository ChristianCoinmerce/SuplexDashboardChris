...
#roles
Route::get('roles/create', [RoleController::class, 'create'])->name('user-role.connect_permission');
Route::post('roles/store', [RoleController::class, 'store'])->name('user_role.store');
