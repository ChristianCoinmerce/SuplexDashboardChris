...
#dashboard
Route::get('/dashboard', [DashboardController::class, 'create'])->name('roles.index');
#roles
...
Route::middleware(['auth'])->group(function () {
  ...
  // show new post form
  Route::get('/home/new-post', [PostController::class, 'create']);
  // save new post
  Route::post('/home/new-post', [PostController::class, 'store']);
  // edit post form
