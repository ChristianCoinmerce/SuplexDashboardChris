...
#roles
Route::get('roles', [RoleController::class, 'create'])->name('roles.index');
Route::post('/roles/store', [RoleController::class, 'store'])->name('roles.store');
Route::post('/roles/update', [RoleController::class, 'update'])->name('roles.store');
Route::get('/roles/destroy/{id}', [RoleController::class, 'destroy'])->name('roles.destroy');

// user_role
Route::get('users', [UserController::class, 'connect_roles'])->name('connect.roles');
