...
Route::group(['middleware' => 'myauthcheck:1'], function () {
    ...
    Route::group(['middleware' => 'myauthcheck:10'], function () {
        Route::get('/dashboard/comment', [CommentController::class, 'create'])->name('comment.index');
    });
    ...
    Route::group(['middleware' => 'myauthcheck:12'], function () {
        Route::get('/dashboard/comment/destroy/{id}', [CommentController::class, 'destroy'])->name('comment.destroy');
    });
