...
Route::delete('user-role/delete/{id}', [UserController::class, 'destroy'])->name('user-role.destroy');
Route::delete('user-role/delete/{id}', [UserController::class, 'store_user'])->name('user-role.store_user');
