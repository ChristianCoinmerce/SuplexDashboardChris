...
class FormStoreRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'iban_name' => 'required|string|max:50',
            'iban_number' => 'required|string|max:50',
            'bic_swift' => 'required|string|max:50',
            'contact_name' => 'required|string|max:50',
            'category' => 'required|string|max:50',
            'subcategory' => 'required|string|max:50',
            'language' => 'required|string|max:50',
            'opening_days' => 'required|min:1',
            'total_hours' => 'required|string|max:24',
        ];
    }
}
