        ...
        <div class="col-12 col-xl-3">
            <div class="card" style="height: 300px; overflow:hidden; ">
                ...
                <div class="card-body row text-center">
                    <div class="col">
                        <div class="text-value-xl">{{ !empty($infos['reportedHashrate']) ? substr($infos['reportedHashrate'], 0,3) : 'NILL' }}<small> MH/s</small></div>
                        <div class="text-uppercase text-muted small">Local</div>
                    </div>
                    <div class="c-vr"></div>
                    <div class="col">
                        <div class="text-value-xl">{{ !empty($infos['reportedHashrate']) ? substr($infos['currentHashrate'], 0,3) : 'NILL' }}<small> MH/s</small></div>
                        <div class="text-uppercase text-muted small">Pool</div>
                    </div>
                    <div class="c-vr"></div>
                    <div class="col">
                        <div class="text-value-xl">{{ !empty($infos['reportedHashrate']) ? substr($infos['averageHashrate'], 0,3) : 'NILL' }}<small> MH/s</small></div>
...
{{---------------------------------------------------------------------}}
        ...
        <div class="col-12 col-xl-3">
            ...
            <div class="card" style="height: 300px; overflow:hidden; max-height:174px">
                ...
                <div class="card-body row text-center" style="    margin-top: -5px;">
                    <div class="col">
                        ...
                        <div class="text-value-xl" style="font-size:21px">€{{ str_replace(".", ",",substr($ifos['coinsPerMin']*1440*$price_eur, 0,5)) }}</div>
                ...
                <div class="card-footer">Current Ether price:
                    <b>€{{ !empty($msinfos['cprice']) ? floor($msinfos['cprice']/$price_usd *100)/100 : 'NILL' }} / ${{ !empty($msinfos['cprice']) ? floor($msinfos['cprice'] *100)/100 : 'NILL' }}</b>
                </div>
            </div>
            ...
            <div class="card" style="height: 300px; overflow:hidden; ">
                ...
                <div class="card-body row text-center">
                    <div class="col">
                        <div class="text-value-xl" style="font-size: 22px">{{ !empty($msinfos['status']) ? strtoupper($msinfos['status']) : 'NILL' }}</div>
                        <div class="text-uppercase text-muted small">Uptime</div>
                    </div>
                    <div class="c-vr"></div>
                    <div class="col">
                        <div class="text-value-xl">{{ !empty($msinfos['consumption']) ? $msinfos['consumption'] : 'NILL' }}W</div>
                        <div class="text-uppercase text-muted small">Consumption</div>
                    </div>
                    <div class="c-vr"></div>
                    <div class="col">
                        <div class="text-value-xl">{{ !empty($msinfos['devices']) ? $msinfos['devices'] : 'NILL' }}</div>
                        <div class="text-uppercase text-muted small">Rigs</div>
                    </div>
                </div>
                <div class="card-body row text-center">
                    <div class="col">
                        {{-- <div class="text-value-xl">@if($msinfos['status'] == 'online')@foreach($msinfos['shares'] as $share) @if($loop->first){{ $share}} @endif @endforeach @endif</div> --}}
                        <div class="text-uppercase text-muted small">Valid Shares</div>
                    </div>
                    <div class="c-vr"></div>
                    <div class="col">
                ...
                <div class="card-footer">Pool:
                    <b>{{ !empty($msinfos['pool']) ? $msinfos['pool'] : 'NILL' }}</b>
                </div>
            </div>
        </div>
