                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    @foreach($role->permission as $permission)
                                                        ...
                                                        @case('dashboard')
                                                            @if ($permission['name']=="AdminPanel")
                                                            <div style="background-color:#ced2d8;; border-radius:5px; "><h5>&nbsp;&nbsp;{{ $permission['name'] }}</h5></div>
                                                            <?php $dash = 1 ?>
                                                            @elseif($permission['name']=="AdminPanel")
                                                                <?php $dash = 0 ?>
                                                            @endif
                                                        @break
                                                        @case('user_crud')
                                                        ...
                                                        @case('homepage')
                                                            @if ($dash == 1)
                                                                <div style="margin-bottom: 20px"></div>
                                                                <div style="background-color:#ced2d8;; border-radius:5px;"><h5>&nbsp;&nbsp;{{ $dash }}margin</h5></div>
                                                            @else
                                                                <div style="background-color:#ced2d8;; border-radius:5px;"><h5>&nbsp;&nbsp;{{ $dash }}no-margin</h5></div>
                                                            @endif
                                                        @break
                                                        @case('posts_user')
                                                            @if ($a5==0)
