		...
		<div class="table-wrapper">
            ...
            @foreach($users as $user)
				<tbody><tr>
                    ...
                    <a href="#deleteEmployeeModal{{ $user['id'] }}" class="delete" data-toggle="modal">D</a>
                    <div id="editUserModal{{ $user['id'] }}" data-id="" class="modal fade">
                    ...
                    <div id="deleteEmployeeModal{{ $user['id'] }}" class="modal fade">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <form method="post" action="{{  route('/user-role/delete/{id}') }}">
                                    <div class="modal-header">
                                    ...
                                    <div class="button">
                                        <input type="button" class="btn btn-default" data-dismiss="modal" value="Cancel">
                                        <a href="{{  url('user-role/delete/'.$user['id']->id) }}"><button class="btn btn-danger">Delete</button></a>
                                    </div>
                                    </div>
                                </form>
                            </div>
...
{{-- <div id="deleteEmployeeModal" class="modal fade">
	<div class="modal-dialog">
		<div class="modal-content">
			<form method="POST" action="{{  route('user-role.destroy') }}">
				<div class="modal-header">
					<h4 class="modal-title">Delete Employee</h4>
					<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
				</div>
