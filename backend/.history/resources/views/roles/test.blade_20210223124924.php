                ...
                <div wire:id="OHqZ850z9DMlg6G3eIhu" class="">
                    ...
                    <div class="table-responsive">
                        <table class="table table-striped">
                            <thead class="">
                                <tr>
                                    <th class="" id="" wire:click="sort('type')" style="cursor:pointer;">ID<i class="text-muted fas fa-sort"></i></th>
                                    ...
                                    <th class="" id="" wire:click="sort('email_verified_at')" style="cursor:pointer;">Role<i class="text-muted fas fa-sort"></i></th>
                                    <th class="" id="" wire:click="sort('2fa')" style="cursor:pointer;">Permissions<i class="text-muted fas fa-sort"></i></th>
