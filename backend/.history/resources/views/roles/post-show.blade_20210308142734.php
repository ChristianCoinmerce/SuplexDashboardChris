...
@section('title')
<a href="{{ url('dashboard/posts')}}" style="color: black; color: inherit !important; text-decoration:none !important;">Posts Management</a>&nbsp; /&nbsp;{!! Str::limit($post->title, $limit = 40, $end = '....') !!}
