                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    @foreach($role->permission as $permission)
                                                        ...
                                                        @case('dashboard')<div style="background-color:#ced2d8;; border-radius:5px; border-bottom: -50px;"><h5>&nbsp;&nbsp;{{ $permission['name'] }}</h5></div>@break
                                                        @case('user_crud')
                                                            @if ($a1==0)
                                                                <br><br>
                                                                <?php $a1++; ?>
                                                        ...
                                                        @case('comments_crud')
                                                            ...
                                                            @endif
                                                        @break
                                                        @case('homepage')<div style="background-color:#ced2d8;; border-radius:5px; margin-top:15px;"><h5>&nbsp;&nbsp;{{ $permission['name'] }}</h5></div>@break
                                                        @case('posts_user')
                                                            @if ($a5==0)
