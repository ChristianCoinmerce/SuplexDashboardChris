                            ...
                            <tbody>
                                <tr class="" id="">
                                    ...
                                    <td>
                                        ...
                                        {{ $loop->first ? '' : ', ' }}
                                        <button class="btn btn-secondary" type="button" data-container="body" data-toggle="popover" data-placement="bottom" data-content="Vivamus sagittis lacus vel augue laoreet rutrum faucibus.">Hover</button>
                                        @endforeach
                                        @else
                                        None
                                        @endif
