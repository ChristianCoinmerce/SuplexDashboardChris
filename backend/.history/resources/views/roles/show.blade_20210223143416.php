                                    ...
                                    <td class="" id="">
                                        ...
                                        <div class="dropdown d-inline-block">
                                            ...
                                            <div class="dropdown-menu" aria-labelledby="moreMenuLink">
                                                ...
                                                <a href="#editUserModal{{ $user['id'] }}" data-toggle="modal" class="btn btn-primary btn-sm">Edit</a>
                                        <a href="#deleteUserModal{{ $user['id'] }}" data-toggle="modal" class="btn btn-danger btn-sm">Delete</a>
                                            </div>
                                        </div>
                                    </td>
                                </tr>
