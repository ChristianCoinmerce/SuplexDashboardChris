                        ...
                        <table class="table table-striped">
                            ...
                            <tbody>
                                <tr class="" id="">
                                    ...
                                    <td>
                                        <button class="btn btn-sm btn-secondary" tabindex="0" role="button" data-toggle="popover" data-trigger="focus" data-placement="right" data-content="
                                        @if($role->permission()->exists())

                                            Posts:
                                            @switch($role->permission as $permission['keyword'])
                                            @case('comments_user'){{ $permission['keyword'] }}
                                            @case('posts_user'){{ $permission['name'] }}
                                            @endswitch
