		...
		<div class="table-wrapper">
			<div class="table-title" style="background-color:#212529;">
				<div class="row">
					...
					<div class="col-sm-6">
						...
						<a href="#deleteUserModal2" class="btn btn-danger" data-toggle="modal">Delete</a> <label class="button" for="submit">Submit</label>
					</div>
				</div>
			</div>
            ...
            @foreach($users as $user)
				<tbody><tr>
                    <td>
                        <span class="custom-checkbox">
                            <form method="get" action="{{ route('user-role.destroyAll') }}" id="form1">
                    ...
                    <div id="deleteUserModal2" class="modal fade">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="button">
                                    <input type="button" class="btn btn-default" data-dismiss="modal" value="Cancel">
                                    <input type="hidden" name="_method" for="submit" value="delete"> <label class="button" for="submit">Submit</label>
                                </div>
                                </div>
                            </div>
                        </div>
