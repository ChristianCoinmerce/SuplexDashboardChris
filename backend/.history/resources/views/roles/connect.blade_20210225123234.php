                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    @foreach($role->permission as $permission)
                                                        ...
                                                        @case('homepage')
                                                            @if (true)
                                                                <div style="margin-bottom: 20px"></div>
                                                                <div style="background-color:#ced2d8;; border-radius:5px;"><h5>&nbsp;&nbsp;dash:{{ $permission['name'] }}, margin</h5></div>
                                                            @elseif (true)
                                                                <div style="background-color:#ced2d8;; border-radius:5px;"><h5>&nbsp;&nbsp;dash:{{ $permission['keyword'] }}, no-margin</h5></div>
                                                            @endif
                                                        @break
                                                        @case('posts_user')
                                                            @if ($a5==0)
