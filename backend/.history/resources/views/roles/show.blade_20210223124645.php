    ...
    <div class="fade-in">
        <div class="card">
            <div class="card-header">
                ...
                <!--card-header-actions--><div id="addEmployeeModal1" class="modal fade">
            ...
            <form enctype="multipart/form-data" method="post" action="">
				...
				<div class="modal-body">
					...
					<div class="form-group">
                        ...
                        <input type="hidden" name="user_id" class="element text" maxlength="255" size="8" value=""/></input>
                    <div class="form-group">
                        <label>Role</label>
                    <div class="form-group">
                ...
                <div wire:id="OHqZ850z9DMlg6G3eIhu" class="">
                    ...
                    <div class="table-responsive">
                        <table class="table table-striped">
                            <thead class="">
                                <tr>
                                    <th class="" id="" wire:click="sort('type')" style="cursor:pointer;">Type<i class="text-muted fas fa-sort"></i></th>
                                    <th class="" id="" wire:click="sort('name')" style="cursor:pointer;">Name<i class="fas fa-sort-up"></i></th>
                                    <th class="" id="" wire:click="sort('email')" style="cursor:pointer;">E-mail<i class="text-muted fas fa-sort"></i></th>
                                    <th class="" id="" wire:click="sort('email_verified_at')" style="cursor:pointer;">Verified<i class="text-muted fas fa-sort"></i></th>
                                    <th class="" id="" wire:click="sort('2fa')" style="cursor:pointer;">2FA<i class="text-muted fas fa-sort"></i></th>
                                    <th class="" id="">Roles</th>
                                    <th class="" id="">Additional Permissions</th>
