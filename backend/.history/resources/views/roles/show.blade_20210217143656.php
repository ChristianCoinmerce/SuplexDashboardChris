			...
			<div class="table-title" style="background-color:#212529;">
				<div class="row">
					...
					<div class="col-sm-6">
                        ...
                        <a href="{{  url('user-role/destroyAll') }}"><button class="btn btn-danger"  id="form-submit-button">Delete All</button></a>
					</div>
				</div>
			</div>
            ...
            @foreach($users as $user)
				<tbody><tr>
                    <td>
                        ...
                        </span>                                <a href="{{  url('user-role/destroyAll') }}"><button class="btn btn-danger"  id="form-submit-button">Delete All</button></a>
