			...
			<div class="table-title" style="background-color:#212529;">
				<div class="row">
					...
					<div class="col-sm-6">
						...
						<a href="#deleteUserModal2{{ $users['id'] }}" class="btn btn-danger" data-toggle="modal">Delete</a>
					</div>
				</div>
			</div>
...
<div id="deleteUserModal2{{ $users['id'] }}" class="modal fade">
	<div class="modal-dialog">
		<div class="modal-content">
			<form method="get" action="{{  route('user-role.destroyAll') }}">{{ csrf_field() }}
				<div class="modal-header">
					<h4 class="modal-title">Delete Employee</h4>
					<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
				</div>
				...
				<div class="button">
					<input type="button" class="btn btn-default" data-dismiss="modal" value="Cancel">
                    <input type="hidden" class="btn btn-danger" name="_method" value="delete"><button type="submit" >Delete all</button>
				</div>
                </div>
			</form>
		</div>
