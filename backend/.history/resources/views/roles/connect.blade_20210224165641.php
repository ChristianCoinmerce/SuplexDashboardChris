                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    @foreach($role->permission as $permission)
                                                        ...
                                                        @case('comments_user'){{ $permission['name'] }}<br> @break
                                                        @case('posts_user'){{ $permission['name'] }} <br>@break
                                                        @case('dashboard') {{ $permission['name'] }}<br> @break
                                                        @case('user_crud') {{ $permission['name'] }}<br> @break
                                                        @case('roles_crud') {{ $permission['name'] }}<br> @break
                                                        @case('posts_crud') {{ $permission['name'] }}<br> @break
                                                        @case('comments_crud') {{ $permission['name'] }}<br> @break
                                                        @case('homepage') {{ $permission['name'] }}<br> @break
                                                        @case('posts_user') {{ $permission['name'] }}<br> @break
                                                        @case('comments_user') {{ $permission['name'] }}<br> @break
                                                        @case('profile_user') {{ $permission['name'] }}<br> @break
