		...
		<div class="table-wrapper">
			<div class="table-title" style="background-color:#212529;">
				<div class="row">
					...
					<div>
						<a href="#addEmployeeModal1" class="btn btn-success" data-toggle="modal">Add User</a>
                        <a href="#addEmployeeModal2" class="btn btn-success" data-toggle="modal">Add Role</a>
            ...
            @foreach($users as $user)
				<tbody><tr>
                    <td>
                        <span class="custom-checkbox">
                            <input type="checkbox" name="delete[]" id="" value="{{ $user['id'] }}"></a>
...
<div id="addEmployeeModal2" class="modal fade">
	<div class="modal-dialog">
		<div class="modal-content">
            <form enctype="multipart/form-data" method="post" action="{{ route('user-role.create') }}">
                <input type="hidden" name="_token" value="{{ csrf_token() }}"/>
				<div class="modal-header">
				...
				<div class="modal-body">
					...
					<div class="form-group">
                        ...
                        <input type="hidden" name="permission" class="element text" maxlength="255" size="8" value="{{ $permission['id'] }}"/></input>
                    <div class="form-group">
