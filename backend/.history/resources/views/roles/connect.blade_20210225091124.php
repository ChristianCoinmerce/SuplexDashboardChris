                                ...
                                <tr class="" id="">
                                    ...
                                    <td class="" id="">
                                        ...
                                        <div id="showPermission{{ $role['id'] }}" class="modal fade">
                                            <div class="modal-dialog">
                                                <div class="modal-content"><? $i = 0; $len = count($array) ?>
                                                    @if($role->permission()->exists())
                                                    @foreach($role->permission as $permission)
                                                        @switch($permission['keyword'])
                                                        @case('dashboard') {{ $permission['description'] }}<br> @break
                                                        @case('user_crud') @if(true)
                                                            {{ $permission['name'] }}<br> @break
                                                        @endif
                                                        @case('roles_crud')- {{ $permission['description'] }}<br> @break
                                                        @case('posts_crud')- {{ $permission['description'] }}<br> @break
                                                        @case('comments_crud')- {{ $permission['description'] }}<br> @break
                                                        @case('homepage') {{ $permission['description'] }}<br> @break
                                                        @case('posts_user')- {{ $permission['description'] }}<br> @break
                                                        @case('comments_user')- {{ $permission['description'] }}<br> @break
                                                        @case('profile_user')- {{ $permission['description'] }}<br> @break
                                                        @endswitch
                                                    @endforeach
                                                    @endif
                                                </div>
