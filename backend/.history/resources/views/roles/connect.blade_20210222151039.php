            ...
            @foreach($roles as $role)
				<tbody><tr>
                    ...
                    <div id="deleteUserModal2" class="modal fade">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <form method="GET" action="{{ route('roles.destroy', $roles['id']) }}">
                                <div class="modal-header">
                                    <h4 class="modal-title">Delete Employee</h4>
                                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                                </div>
            ...
            <form enctype="multipart/form-data" method="post" action="{{ route('roles.store') }}">
				...
				<div class="modal-body">
					...
					<div class="form-group">
                        ...
                        <input type="hidden" name="permission_id" class="element text" maxlength="255" size="8" value="{{ $role['id'] }}"/></input>
                    <div class="form-group">
                        <label>Role</label>
                    <div class="form-group">
                        <small >Use CTRL to multiselect</small>
                        <select multiple class="form-control" name="permiss[]">
                            @if($permissions)
				...
				<div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <select multiple class="form-control" name="permission[]">
                            ...
                            <option value="{{ $permissions['id'] }}" ><h3>{{ $permissions['name'] }}</h3></option>
                            @endforeach
                            @endif
                        </select>
                    </div>
