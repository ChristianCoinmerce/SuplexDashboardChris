                        ...
                        <table class="table table-striped">
                            ...
                            <tbody>
                                <tr class="" id="">
                                    <td>{{ $post->id }}</td>
                                    <td>{{ $post->title }}</td>
                                    <td style="max-width: 400px">{!! strip_tags($post->body, ['<div>','white']) !!}</td>
                                    <td>{{ $post->created_at }}
                                    </td>
                                    <td>
                                                ...
                                                <div class="modal-content">
                                                    <form method="POST" action="{{  route('posts.update') }}">
                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            <div class="form-group">
                                                                <label>Body</label>
                                                                <input value="{{ $post->body }}" name="email" class="form-control">
                                                            </div>
                                                            <input type="hidden" name="id" class="element text" maxlength="255" size="8" value="{{ $post['id'] }}"/></input>
                                                            <div class="button">
