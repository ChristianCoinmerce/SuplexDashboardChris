                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    @foreach($role->permission as $permission)
                                                        ...
                                                        @case('dashboard')<div class="modal-header"><h5>{{ $permission['name'] }}</h5></div><br>@break
                                                        @case('user_crud')
                                                            @if ($a1==0)
                                                                <?php $a1++; ?>
                                                        ...
                                                        @case('comments_crud')
                                                            ...
                                                            @endif
                                                        @break
                                                        @case('homepage')<div class="modal-header" style="border-top: 1px solid grey; border-bottom: 1px solid;"><h5>{{$permission['name']}}</h5></div>@break
                                                        @case('posts_user')
                                                            @if ($a5==0)
                                                                <?php $a5++; ?>
