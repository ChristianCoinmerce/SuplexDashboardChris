                            ...
                            <tbody>
                                <tr class="" id="">
                                    ...
                                    <td>
                                        ...
                                        @foreach($role->permission as $role)
                                        {{ $loop->first ? '' : ', ' }}
                                            {{ $role->name }}
                                        @endforeach
                                        @else
                                    ...
                                    <td class="" id="">
                                                ...
                                                <div class="modal-content">
                                                    <form method="POST" action="{{  route('user-role.store_userrole') }}">
                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            <div class="form-group">
                                                                <label>Email</label>
                                                                <input type="email" value="{{ $role->email }}" name="email" class="form-control">
                                                            </div>
                                                            <input type="hidden" name="user_id" class="element text" maxlength="255" size="8" value="{{ $role['id'] }}"/></input>
                                                            <div class="form-group">
                                                            <label>Role</label>
                                                            <div class="form-group">
                                        ...
                                        <div id="deleteUserModal{{ $role['id'] }}" class="modal fade">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    <form method="GET" action="{{ route('user-role.destroy', $role['id']) }}">
                                                        <input type="hidden" name="_token" value="{{ csrf_token() }}">
                                                        <div class="modal-header">
                                                        ...
                                                        <div class="button">
                                                            <input type="button" class="btn btn-default" data-dismiss="modal" value="Cancel">
                                                            <a href="{{  url('user-role/delete/'.$role['id']) }}"><button class="btn btn-danger">Delete</button></a>
                                                        </div>
                                                        </div>
                                                    </form>
                                                </div>
