                                ...
                                <tr class="" id="">
                                    ...
                                    <td>
                                        ...
                                        @foreach($role->permission as $permission)
                                            ...
                                            @case('comments_user'){{ $jerk = $permission['name'] }} @break
                                            @case('posts_user'){{ $permission['name'] }} @break
                                            @endswitch
                                        @endforeach
                                        @endif
                                        <button class="btn btn-sm btn-secondary" tabindex="0" role="button" data-toggle="popover" data-trigger="focus" data-placement="right" data-content="{{ $jerk }}">Show Perm.</button>
                                    <div></div>
