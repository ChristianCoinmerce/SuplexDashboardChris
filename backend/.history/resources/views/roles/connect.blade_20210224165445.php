                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    @foreach($role->permission as $permission)
                                                        ...
                                                        case('dashboard'):
                                                        $output1.=$permission['name']." ";
                                                        $output11 = explode(" ", $output1);
                                                        case('user_crud'):
                                                                $output2.=$permission['name'];
                                                        case('roles_crud'):
                                                                $output3.=$permission['name'];
                                                        case('posts_crud'):
                                                                $output4.=$permission['name'];
                                                        case('comments_crud'):
                                                                $output5.=$permission['name'];
                                                        case('homepage'):
                                                                $output6.=$permission['name'];
                                                        case('posts_user'):
                                                                $output7.=$permission['name'];
                                                        case('comments_user'):
                                                                $output8.=$permission['name'];
                                                        case('profile_user'):
                                                                $output9.=$permission['name'];
