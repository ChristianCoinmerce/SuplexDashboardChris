...
<div class="container-fluid">
    <div class="fade-in">
        <div class="card">
            ...
            <div class="card-body">
                <div class="">
                    <div class="row mb-4 display: flex; justify-content: flex-end">
                        ...
                        <div class="col form-inline float-sm-right">
                            <input style="width: 200px !important;" class="form-control" type="text"
                                placeholder="Search...">
                        </div>
