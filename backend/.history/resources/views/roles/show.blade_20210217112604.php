		...
		<div class="table-wrapper">
			<div class="table-title" style="background-color:#212529;">
				<div class="row">
					...
					<div class="col-sm-6">
						...
						<a href="#deleteUserModal{{ $users['id'] }}" class="btn btn-danger" data-toggle="modal">Delete</a>
					</div>
				</div>
			</div>
            ...
            @foreach($users as $user)
				<tbody><tr>
                    <td>
                        <span class="custom-checkbox">
                            <input type="checkbox" id="checkItem" name="id[]" value="{{ $user['id']->id }}">
                            <label for="checkbox1"></label>
                            <input name='id[]' type="checkbox" id="checkItem" value="<?php echo $list[$key]->id; ?>">
                        </span>
                    </td>
                    <td>{{ $user->id }}</td>
                    <td>{{ $user->name }}</td>
