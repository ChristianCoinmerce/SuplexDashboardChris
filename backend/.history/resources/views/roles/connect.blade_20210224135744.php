                        ...
                        <table class="table table-striped">
                            ...
                            <tbody>
                                <tr class="" id="">
                                    ...
                                    <td>
                                        <button class="btn btn-sm btn-secondary" tabindex="0" role="button" data-toggle="popover" data-trigger="focus" data-placement="right" data-content=""><a></a></button>

                                        @if($role->permission()->exists())
                                        @foreach($role->permission as $permission)
                                            @switch($permission['keyword'])
                                            daw@case('comments_user'){{ $permission['name'] }}<br> @break
