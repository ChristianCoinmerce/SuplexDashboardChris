            ...
            <div class="card" style="height: 300px; overflow:hidden; min-width: 390px;">
                ...
                <div class="card-body" style="height: 450px; overflow:hidden;">
                    ...
                    <table class="table" style="border: none" cellspacing="0" cellpadding="0">
                        ...
                        <tbody>
                            <tr  >
                                <td style="font-size:20px;">{{ substr($infos['reportedHashrate'], 0,3) }} <small>MH/s</td>
                                <td style="font-size:20px">{{ substr($infos['currentHashrate'], 0,3) }} <small>MH/s</td>
                                <td style="font-size:20px">{{ substr($infos['averageHashrate'], 0,3) }} <small>MH/s</td>
                            </tr>
                        </tbody>
                    </table>
                    ...
                    <table class="table" style="border: none" cellspacing="0" cellpadding="0">
                        ...
                        <tbody>
                            <tr>
                                <td style="font-size:20px;">{{ $infos['validShares'] }} <small>Shares</td>
                                <td style="font-size:20px">{{ $infos['invalidShares'] }} <small>Shares</td>
                                <td style="font-size:20px">{{ $infos['staleShares'] }} <small>Shares</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
