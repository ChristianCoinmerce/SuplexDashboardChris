        ...
        <div class="col-12 col-xl-3">
            ...
            <div class="card" style="height: 300px; overflow:hidden; max-height:174px">
                ...
                <div class="card-footer">Current Ether price:
                    {{ !empty($msinfos['cprice']) ? floor($msinfos['cprice']/$price_usd *100)/100 : 'NILL' }}
                    <b>€{{ !empty($msinfos['cprice']) ? floor($msinfos['cprice']/$price_usd *100)/100 : 'NILL' }} / ${{ !empty($msinfos['cprice']) ? floor($msinfos['cprice']/$price_usd *100)/100 : 'NILL' }}</b>
                </div>
            </div>
