    ...
    <div class="row">
        ...
        <div class="col-xs-6">
            ...
            <div class="card" style="width: 430px; height:175px">
                <div class="card-header" style="font-size: 15px"><div class="row"><div class="col-xs-6">Earnings -  </p><p style="text-align: right">Payout in: @foreach($workers as $key => $worker)
                    @if ($key == 0)
