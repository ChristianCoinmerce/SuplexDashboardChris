        ...
        <div class="col-12 col-xl-3">
            <div class="card" style="height: 300px; overflow:hidden; ">
                <div class="card-header" style="font-size: 15px">Worker Info</div>
                    ...
                    <div class="card-body row text-center">
                        <div class="col">
                            <div class="text-value-xl">{{ $infos['validShares'] }} <small>S</small></div>
                            <div class="text-uppercase text-muted small">Valid</div>
                        </div>
                        <div class="c-vr"></div>
                        <div class="col">
                            <div class="text-value-xl">{{ $infos['invalidShares'] }} <small>S</small></div>
                            <div class="text-uppercase text-muted small">Rejected</div>
                        </div>
                        <div class="c-vr"></div>
                        <div class="col">
                            <div class="text-value-xl">{{ $infos['staleShares'] }} <small>S</small></div>
