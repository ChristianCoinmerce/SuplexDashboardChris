            ...
            <div class="card" style="height: 300px; overflow:hidden; max-height:174px">
                ...
                <div class="card-body row text-center" style="    margin-top: -5px;">
                    ...
                    <div class="col">
                        ...
                        <div class="text-value-xl" style="font-size:21px">€{{ str_replace(".", ",",substr($infos['coinsPerMin']*1440*$price_eur*7, 0,5)) }}</div>
                    ...
                    <div class="col">
                        ...
                        <div class="text-value-xl" style="font-size:21px">€{{ str_replace(".", ",",substr($infos['coinsPerMin']*1440*$price_eur*31, 0,5)) }}</div>
