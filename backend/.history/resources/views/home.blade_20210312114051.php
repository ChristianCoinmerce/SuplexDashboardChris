...
<div class="container-fluid" style="    margin-left: 0px;">
    <div class="row">
        ...
        <div class="row" style="margin-left: 36px; margin-right:36px;">
            <div class="col-sm-6 col-lg-3" style="max-width: 430px; height:300px">
            ...
            <div class="col-sm-6 col-lg-3" style="max-width: 430px; height:175px">
                <div class="card-header" style="font-size: 15px">
                    <div class="row"><div style="margin-left:17px" class="col-xs-6">Earnings </div>
                        <div style="margin-left:183px" class="col-xs-6" >@foreach($workers as $key => $worker)
                            @if ($key == 0)
