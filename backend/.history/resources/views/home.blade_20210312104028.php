        ...
        <div class="col-xs-6">
            ...
            <div class="card" style="width: 430px; height:175px">
                <div class="card-header" style="font-size: 15px">
                    <div class="row"><div style="margin-right:150px" class="col-xs-6">Earnings </div>
                        <div style="margin-left:150px" class="col-xs-6" >Payout in: @foreach($workers as $key => $worker)
                            @if ($key == 0)
