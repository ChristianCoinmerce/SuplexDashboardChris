...
<div class="container-fluid" style="margin-left: 0px;">
    <div class="row">
        ...
        <div class="card-body row text-center">
            <div class="col">
                <div class="text-value-xl">{{ substr($infos['reportedHashrate'], 0,3) }}</div>
                <div class="text-uppercase text-muted small">Local MH/s</div>
            </div>
            <div class="c-vr"></div>
            <div class="col">
                <div class="text-value-xl">{{ substr($infos['currentHashrate'], 0,3) }}</div>
                <div class="text-uppercase text-muted small">Online MH/s</div>
            </div>
            <div class="c-vr"></div>
            <div class="col">
                <div class="text-value-xl">{{ substr($infos['averageHashrate'], 0,3) }}</div>
                <div class="text-uppercase text-muted small">Average MH/s</div>
            </div>
        </div>
                ...
                <div class="card-body" style="height: 450px; overflow:hidden;">
                    ...
                    <table class="table" style="border: none" cellspacing="0" cellpadding="0">
                        <thead">
                            ...
                            <tbody>
                                <tr>
                                    <td style="font-size:20px;">{{ substr($infos['reportedHashrate'], 0,3) }}
                                        <small>MH/s</small></td>
                                    <td style="font-size:20px">{{ substr($infos['currentHashrate'], 0,3) }}
                                        <small>MH/s</small></td>
                                    <td style="font-size:20px">{{ substr($infos['averageHashrate'], 0,3) }}
                                        <small>MH/s</small></td>
                                </tr>
                            </tbody>
                    </table>
