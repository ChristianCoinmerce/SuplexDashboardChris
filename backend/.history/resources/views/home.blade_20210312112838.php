...
<div class="container" style="    margin-left: 0px;">
    <div class="row" style="background-color: green" media="screen and (max-width: 800px)">
        ...
        <div class="col-xs-6" style="background-color:red;margin-left: 36px; margin-right:36px;">
            <div class="card" style="max-width: 430px; height:300px">
            ...
            <div class="card" style="max-width: 430px; height:175px">
                <div class="card-header" style="font-size: 15px">
                    <div class="row"><div style="margin-left:17px" class="col-xs-6">Earnings </div>
                        <div style="margin-left:227px" class="col-xs-6" >@foreach($workers as $key => $worker)
                            @if ($key == 0)
