...
<div id="form_container">
    ...
    <label class="description">WebSite </label>
    <div>
        <input name="website" class="element text medium" type="text" maxlength="255" value="http://"/>
    </div>
    </li><li>
    <label class="description">Opening Days </label>
    <span>
        <input name="opening_days[]" class="element checkbox" type="checkbox" value="Monday" />
        <label class="choice">Monday
            <div class="right"><input name="total_hours[monday:]" class="element text medium" value="" type="text"></div>
        </label>
        <input name="opening_days[]" class="element checkbox" type="checkbox" value="Tuesday" />
        <label class="choice">Tuesday
            <div class="right"><input name="total_hours[tuesday:]" class="element text medium" value="" type="text"></div>
        </label>
        <input name="opening_days[]" class="element checkbox" type="checkbox" value="Wednesday" />
        <label class="choice">Wednesday
            <div class="right"><input name="total_hours[wednesday:]" class="element text medium" value="" type="text"></div>
        </label>
        <input name="opening_days[]" class="element checkbox" type="checkbox" value="Thursday" />
        <label class="choice">Thursday
            <div class="right"><input name="total_hours[thursday:]" class="element text medium" value="" type="text"></div>
        </label>
        <input name="opening_days[]" class="element checkbox" type="checkbox" value="Friday" />
        <label class="choice">Friday
            <div class="right"><input name="total_hours[friday:]" class="element text medium" value="" type="text"></div>
        </label>
        <input name="opening_days[]" class="element checkbox" type="checkbox" value="Saturday" />
        <label class="choice">Saturday
            <div class="right"><input name="total_hours[saturday:]" class="element text medium" value="" type="text"></div>
        </label>
        <input name="opening_days[]" class="element checkbox" type="checkbox" value="Sunday" />
        <label class="choice">Sunday
            <div class="right"><input name="total_hours[sunday:]" class="element text medium" value="" type="text"></div>
        </label>
    </span>
    </li><li>
