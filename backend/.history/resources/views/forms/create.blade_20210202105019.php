...
<div id="form_container">
    ...
    <span>
        <input name="opening_days" class="element checkbox" type="checkbox" value="1" />
            ...
            <input name="element_24_3" class="element checkbox" type="checkbox" value="Wednesday" />
            <label class="choice">Wednesday</label>
            <input name="element_24_4" class="element checkbox" type="checkbox" value="Thursday" />
            <label class="choice">Thursday</label>
            <input name="element_24_5" class="element checkbox" type="checkbox" value="Friday" />
            <label class="choice">Friday</label>
            <input name="element_24_6" class="element checkbox" type="checkbox" value="Saturday" />
            <label class="choice">Saturday</label>
            <input name="element_24_7" class="element checkbox" type="checkbox" value="Sunday" />
