...
<div id="form_container">
    ...
    <div>
        <input id="element_16" name="contact_name" class="element text medium" type="text" maxlength="255" value=""/>
    </div>
    </li>		<li id="li_3" >
    <label class="description" for="element_3">House Adress</label>
    <div class="left">
        <input id="element_3_3" name="street" class="element text medium" value="" type="text">
        <label for="element_3_3">Adress</label>
    </div>
    <div class="right">
        <input id="element_3_4" name="house_number" class="element text medium" value="" type="text">
