...
<div id="form_container">
    ...
    <div>
        <input name="phone_country_code" class="element text small" type="text" maxlength="255" value=""/>
    </div>
    </li><li>
    ...
    <span>
        <input name="opening_days" class="element checkbox" type="checkbox" value="1" />
            <label class="choice">Monday</label>
            <input name="element_24_2" class="element checkbox" type="checkbox" value="1" />
            <label class="choice">Tuesday</label>
            <input name="element_24_3" class="element checkbox" type="checkbox" value="1" />
            <label class="choice">Wednesday</label>
            <input name="element_24_4" class="element checkbox" type="checkbox" value="1" />
            <label class="choice">Thursday</label>
            <input name="element_24_5" class="element checkbox" type="checkbox" value="1" />
            <label class="choice">Friday</label>
            <input name="element_24_6" class="element checkbox" type="checkbox" value="1" />
            <label class="choice">Saturday</label>
            <input name="element_24_7" class="element checkbox" type="checkbox" value="1" />
    ...
    <div>
        <input name="bic/swift" class="element text medium" type="text" maxlength="255" value=""/>
    </div>
    </li><li class="section_break">
        <p></p>
    </li>
