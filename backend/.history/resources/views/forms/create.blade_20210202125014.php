...
<div id="form_container">
    ...
    <label class="description">Opening Days </label>            <div class="right"><input name="house_number" class="element text medium" value="" type="text"></div>

    <span>
        <input name="opening_days[]" class="element checkbox" type="checkbox" value="Monday" />
        <label class="choice">Monday
            <div class="right"><input name="house_number" class="element text medium" value="" type="text"></div>
        </label>
