...
<div class="container-fluid" style="margin-left: 0px;">
    <div class="row">
        ...
        <div class="card-body row text-center">
            <div class="col">
                <div class="text-value-xl">{{ substr($infos['reportedHashrate'], 0,3) }} <small>Shares</small></div>
                <div class="text-uppercase text-muted small">Valid</div>
            </div>
            <div class="c-vr"></div>
            <div class="col">
                <div class="text-value-xl">{{ substr($infos['currentHashrate'], 0,3) }} <small>Shares</small></div>
                <div class="text-uppercase text-muted small">Rejected</div>
            </div>
            <div class="c-vr"></div>
            <div class="col">
                <div class="text-value-xl">{{ substr($infos['averageHashrate'], 0,3) }} <small>Shares</small></div>
                <div class="text-uppercase text-muted small">Stale</div>
            </div>
        </div>
