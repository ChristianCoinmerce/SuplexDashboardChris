...
<div class="container-fluid" style="    margin-left: 0px;">
    <div class="row">
        ...
        <div class="card" style="margin-left: 36px; margin-right:36px;">
            <div class="col-xs-6" style="max-width: 430px; height:300px">
            ...
            <div class="col-xs-6" style="max-width: 430px; height:175px">
