<ul class="c-sidebar-nav ps">
    <li class="c-sidebar-nav-item">
         <a href="https://demo.laravel-boilerplate.com/admin/dashboard" class="c-sidebar-nav-link"><i class="c-sidebar-nav-icon cil-speedometer"></i> Dashboard</a>
        ...
        <li class="c-sidebar-nav-dropdown c-open">
             <a href="#" class="c-sidebar-nav-dropdown-toggle"><i class="c-sidebar-nav-icon cil-user"></i> dwa</a>


            <ul class="c-sidebar-nav-dropdown-items">
                                        <li class="c-sidebar-nav-item">
                         <a href="https://demo.laravel-boilerplate.com/admin/auth/user" class="c-active c-sidebar-nav-link">User Management</a>
