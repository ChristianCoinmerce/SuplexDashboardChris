      ...
      <header class="c-header c-header-light c-header-fixed c-header-with-subheader">
        ...
        <div class="c-subheader px-3">
          <ol class="breadcrumb border-0 m-0">
            <li class="breadcrumb-item" style="color: inherit !important; text-decoration:none !important; color:black !important"><a href="/" style="    color: darkslategrey;">Home</a></li>
            <?php $segments = ''; ?>
