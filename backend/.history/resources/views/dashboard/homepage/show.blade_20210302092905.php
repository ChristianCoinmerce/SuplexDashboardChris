    ...
    <div class="col-md-8">
        <div class="card">
            ...
            <div class="card-footer" >
                ...
                <button class="btn-sm btn-primary"  style="float: right"><a href="{{ url('home/edit/'.$post->slug)}}" style="color: white; float: right">Edit Post</a></button>
                <a href="{{  url('home/delete/'.$post->id.'?_token='.csrf_token()) }}" class="btn-sm btn-danger" style="color: white; float: right">Delete</a>
            </div>
