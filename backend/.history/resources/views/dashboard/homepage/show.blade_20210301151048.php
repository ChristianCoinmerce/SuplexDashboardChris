                    ...
                    <form method="post" action="/home/comment/add">
                        ...
                        <div class="form-group">
                            <div class="form-inline">
                                <input style="width: 100%" class="form-control mr-1" name="body">
                                <button name='post_comment' class="btn btn-success" >Post</button>
                            </div>

                            <div class="input-group mb-3">
                                <input type="text" class="form-control" placeholder="Recipient's username" name="body" aria-label="Recipient's username" aria-describedby="basic-addon2">
