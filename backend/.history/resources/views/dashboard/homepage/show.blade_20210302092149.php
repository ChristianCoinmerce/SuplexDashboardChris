    ...
    <div class="col-md-8">
        <div class="card">
            ...
            <div class="card-footer" >
                ...
                <button class="btn btn-primary"  style="float: right; color:white"><a href="{{ url('home/edit/'.$post->slug)}}">Edit Post</a></button>
                <button class="btn btn-danger" style="float: right; color:white"><a href="{{  url('home/delete/'.$post->id.'?_token='.csrf_token()) }}">Delete</a></button>
            </div>
