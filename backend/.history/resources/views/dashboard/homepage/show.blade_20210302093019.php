    ...
    <div class="col-md-8">
        <div class="card">
            ...
            <div class="card-footer" >
                ...
                <a href="{{ url('home/edit/'.$post->slug)}}" style="color: white; float: right;" class="btn-sm btn-primary">Edit Post</a>
                <a href="{{  url('home/delete/'.$post->id.'?_token='.csrf_token()) }}" class="btn-sm btn-danger" style="margin-right:3px; color: white; float: right">Delete</a>
            </div>
        </div>
        <div class="card">
            <div class="card-body">
