    ...
    <div class="col-md-8">
        <div class="card">
            ...
            <div class="card-footer" >
                ...
                <button class="btn btn-primary"  style="float: right"><a href="{{ url('home/edit/'.$post->slug)}}" style="color: white">Edit Post</a></button>
                <button class="btn btn-danger" style="float: right"><a href="{{  url('home/delete/'.$post->id.'?_token='.csrf_token()) }}" style="color: white">Delete</a></button>
            </div>
                        ...
                        <div class="form-group">
                            <div class="input-group mb-3">
                                ...
                                <div class="input-group-append">
                                  <button class="btn btn-sm-outline-success" name='post_comment'  type="button">Post</button>
                                </div>
                            </div>
                        </div>
                    </form>
