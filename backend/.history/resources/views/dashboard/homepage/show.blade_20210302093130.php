    ...
    <div class="col-md-8">
        <div class="card">
            ...
            <div class="card-footer" >
                ...
                <a href="{{ url('home/edit/'.$post->slug)}}" style="color: white; float: right; pointer-events: none;" class="btn-sm btn-info">Edit Post</a>
                <a href="{{  url('home/delete/'.$post->id.'?_token='.csrf_token()) }}" class="btn-sm btn-warning" style="margin-right:3px; color: white; float: right; pointer-events: none;">Delete</a>
            </div>
        </div>
        <div class="card">
            <div class="card-body">
