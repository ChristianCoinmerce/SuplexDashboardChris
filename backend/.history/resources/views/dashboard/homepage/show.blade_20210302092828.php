    ...
    <div class="col-md-8">
        <div class="card">
            ...
            <div class="card-footer" >
                ...
                <button class="btn-sm btn-primary"  style="float: right"><a href="{{ url('home/edit/'.$post->slug)}}" style="color: white">Edit Post</a></button>
                <button class="btn-sm btn-danger" style="float: right"><a href="{{  url('home/delete/'.$post->id.'?_token='.csrf_token()) }}" style="color: white; float: right">Delete</a></button>
            </div>
