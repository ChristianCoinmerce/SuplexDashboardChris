...
{{---------------------------------------------------------------------}}
        ...
        <div class="col-12 col-xl-3">
            <div class="card" style="height: 300px; overflow:hidden; ">
                ...
                <div class="card-body row text-center">
                    <div class="col">
                        <div class="text-value-xl">{{ $msinfos['usd_day'] }} <small>USD</small></div>
                        <div class="text-uppercase text-muted small">Local</div>
                    </div>
                    <div class="c-vr"></div>
                    <div class="col">
                        <div class="text-value-xl">{{ $msinfos['usd_week'] }} <small>USD</small></div>
                        <div class="text-uppercase text-muted small">Pool</div>
                    </div>
                    <div class="c-vr"></div>
                    <div class="col">
                        <div class="text-value-xl">{{ $msinfos['usd_month'] }} <small>USD</small></div>
                        <div class="text-uppercase text-muted small">Average</div>
                    </div>
                </div>
                <div class="card-body row text-center">
            ...
            <div class="card" style="height: 300px; overflow:hidden; max-height:174px">
                ...
                <div class="card-body row text-center" style="    margin-top: -5px;">
                    <div class="col">
                        <div class="text-value-xl">€{{ substr(number_format(str_replace(".", "",$msinfos['usd_day']/$price_usd), 1), 0,5) }}</div>
                        <div class="text-uppercase text-muted small">Daily</div>
                    </div>
                    <div class="c-vr"></div>
                    <div class="col">
                        <div class="text-value-xl">€{{ substr(number_format(str_replace(".", "",$msinfos['usd_week']/$price_usd), 1), 0,5) }}</div>
                        <div class="text-uppercase text-muted small">Weekly</div>
                    </div>
                    <div class="c-vr"></div>
                    <div class="col">
                        <div class="text-value-xl">€{{ substr(number_format(str_replace(".", "",$msinfos['usd_month']/$price_usd), 1), 0,5) }}</div>
                        <div class="text-uppercase text-muted small">Monthly</div>
                    </div>
                </div>
                <div class="card-footer">Current Ether price:
                    €{{ floor($msinfos['cprice']/$price_usd) }}
                </div>
            </div>
        </div>
