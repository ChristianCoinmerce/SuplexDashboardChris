                    ...
                    <ul class="navbar-nav ml-auto">
                        <li class="nav-item dropdown">
                            ...
                            <div aria-labelledby="navbarDropdown" class="dropdown-menu dropdown-menu-right">
                                <a href="https://demo.laravel-boilerplate.com/dashboard"
                                    class="active dropdown-item">Dashboard</a>
                                <a
                                    href="https://demo.laravel-boilerplate.com/account" class="dropdown-item">My
                                    Account</a> <a href="#"
                                    ...
                                    value="fuI7J3rFbmOF2lBrJlDRpTgQzgrrjDlRKIS7qatY"></form></a>
                            </div>
                        </li>
                    </ul>
                </div>
