            ...
            <div id="navbarSupportedContent" class="collapse navbar-collapse">
                <ul class="c-header-nav ml-auto mr-4">
                    ...
                    <li class="c-header-nav-item d-md-down-none mx-2"><a class="c-header-nav-link">
                        <svg class="c-icon">
                          <use xlink:href="http://localhost:8888/icons/sprites/free.svg#cil-bell"></use>
                        </svg></a></li>
                    <li class="c-header-nav-item d-md-down-none mx-2"><a class="c-header-nav-link">
                        <svg class="c-icon">
                          <use xlink:href="http://localhost:8888/icons/sprites/free.svg#cil-list-rich"></use>
                        </svg></a></li>
                    <li class="c-header-nav-item d-md-down-none mx-2"><a class="c-header-nav-link">
                        <svg class="c-icon">
                          <use xlink:href="http://localhost:8888/icons/sprites/free.svg#cil-envelope-open"></use>
                        </svg></a></li>
