        ...
        <div class="col-12 col-xl-3">
            ...
            <div class="card" style="height: 300px; overflow:hidden; max-height:174px">
                ...
                <div class="card-body row text-center" style="    margin-top: -5px;">
                    <div class="col">
                        <div class="text-value-xl">€{{ str_replace(".", ",",substr($infos['unpaid']*$price_eur*100, 0,5)) }}</div>
                    ...
                    <div class="c-vr"></div>
                    <div class="col">
                        <div class="text-value-xl">€{{ str_replace(".", ",",substr($infos['coinsPerMin']*1440*$price_eur)) }}</div>
