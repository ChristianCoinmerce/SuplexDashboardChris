...
{{---------------------------------------------------------------------}}
        ...
        <div class="col-12 col-xl-3">
            ...
            <div class="card" style="height: 300px; overflow:hidden; max-height:174px">
                ...
                <div class="card-body row text-center" style="    margin-top: -5px;">
                    <div class="col">
                        <div class="text-value-xl" style="font-size:24px">€{{ str_replace(".", ",",substr($msinfos['usd_day']/$price_usd, 0,5)) }}</div>
                        <div class="text-uppercase text-muted small">Daily</div>
                    </div>
                    <div class="c-vr"></div>
                    <div class="col">
                        <div class="text-value-xl" style="font-size:24px">€{{ str_replace(".", ",",substr($msinfos['usd_week']/$price_usd, 0,6)) }}</div>
                        <div class="text-uppercase text-muted small">Weekly</div>
                    </div>
                    <div class="c-vr"></div>
                    <div class="col">
                        <div class="text-value-xl" style="font-size:24px">€{{ str_replace(".", ",",substr($msinfos['usd_month']/$price_usd, 0,6)) }}</div>
