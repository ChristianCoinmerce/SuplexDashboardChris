...
<div class="container-fluid" style="margin-left: 0px;">
    <div class="row">
        ...
        <div class="col-12 col-xl-3">
            <div class="card" style="height: 300px; overflow:hidden; min-width: 390px;">
                ...
                <div class="card-body" style="height: 450px; overflow:hidden;">
                    ...
                    <table class="table" style="border: none" cellspacing="0" cellpadding="0">
                        ...
                        <tbody>
                            <tr  >
                                <td style="font-size:20px;">{{ substr($infos['reportedHashrate'], 0,3) }} <small>MH/s</small></td>
                                <td style="font-size:20px">{{ substr($infos['currentHashrate'], 0,3) }} <small>MH/s</small></td>
                                <td style="font-size:20px">{{ substr($infos['averageHashrate'], 0,3) }} <small>MH/s</small></td>
                            </tr>
                        </tbody>
                    </table>
                    ...
                    <table class="table" style="border: none" cellspacing="0" cellpadding="0">
                        ...
                        <tbody>
                            <tr>
                                <td style="font-size:20px;">{{ $infos['validShares'] }} <small>Shares</small></td>
                                <td style="font-size:20px">{{ $infos['invalidShares'] }} <small>Shares</small></td>
                                <td style="font-size:20px">{{ $infos['staleShares'] }} <small>Shares</small></td>
                            </tr>
                        </tbody>
                    </table>
                </div>
            ...
            <div class="card" style="min-width: 390px; overflow:hidden;">
            ...
            <canvas class="chart chartjs-render-monitor" id="card-chart1" height="70" style="display: block; width: 258px; height: 70px;" width="258"></canvas>
            </div>
            </div>
            </div>
            ...
            <div class="c-chart-wrapper mt-3 mx-3" style="height:70px;"><div class="chartjs-size-monitor"><div class="chartjs-size-monitor-expand"><div class=""></div></div><div class="chartjs-size-monitor-shrink"><div class=""></div></div></div>
            <canvas class="chart chartjs-render-monitor" id="card-chart2" height="70" width="258" style="display: block; width: 258px; height: 70px;"></canvas>
            <div id="card-chart2-tooltip" class="c-chartjs-tooltip top" style="opacity: 0; left: 104.76px; top: 127.516px;"><div class="c-tooltip-header"><div class="c-tooltip-header-item">March</div></div><div class="c-tooltip-body"><div class="c-tooltip-body-item"><span class="c-tooltip-body-item-color" style="background-color: rgb(51, 153, 255);"></span><span class="c-tooltip-body-item-label">My First dataset</span><span class="c-tooltip-body-item-value">9</span></div></div></div></div>
            </div>
            </div>
            ...
            <canvas class="chart chartjs-render-monitor" id="card-chart3" height="70" width="290" style="display: block; width: 290px; height: 70px;"></canvas>
            </div>
            </div>
            </div>
            ...
            <div class="c-chart-wrapper mt-3 mx-3" style="height:70px;"><div class="chartjs-size-monitor"><div class="chartjs-size-monitor-expand"><div class=""></div></div><div class="chartjs-size-monitor-shrink"><div class=""></div></div></div>
            <canvas class="chart chartjs-render-monitor" id="card-chart4" height="70" width="258" style="display: block; width: 258px; height: 70px;"></canvas>
            </div>
            </div>
            </div>
