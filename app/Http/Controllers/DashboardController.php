...
class DashboardController extends Controller
{
    public function index()
    {
        ...
        $payouts = json_decode(file_get_contents('https://api.ethermine.org/miner/36d96338811ee619a154e2777b8ea1a58a9df674/payouts/'), true);
        ...
        return view('home', ['workers' => $json], ['price_eur' => $exchange['price']]);
    }
